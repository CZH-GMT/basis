...
class MyAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (position == 0) {
            ...
            Bean.DataBean.CatalogBean catalogBean = list.get(position-1);
            Glide.with(context).load(catalogBean.getIcon()).into(viewHolder1.iv);
            viewHolder1.tv.setText(catalogBean.getName());
